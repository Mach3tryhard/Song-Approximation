...
#Programul salveaza toate imaginile in ./imagini
#Audio-ul reconstruit este salvat in folderul curent
#Programul MultipleRunErrorCalc.py este similar ca acesta, doar ca va rula pentru iteratii multiple pt. a genera un graf de eroare in raport cu numarul de valori proprii din SVD
